...
function MainApp() {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-12 px-6 py-6">
      <h1 className="text-4xl font-bold text-center mb-10 text-amber-700">
        <span className="text-orange-400 bg-red-900 rounded-xl"> AryaAI </span> : The Smart Travel Agent
      </h1>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                <Link to="/" className="text-black hover:text-green-600 px-3 py-2 rounded-md text-sm font-medium">
                  Home
                </Link>
                <Link to="/admin" className="bg-green-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium">
                  Admin Dashboard
                </Link>
              </div>
            </div>
